...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Cachetes...\n\n ¿Cómo te hago entender?\n\n Que así como amo tu felicidad amo tu tristeza \n amo tus triunfos y tragedias \n me enamore de tus páginas no solo de la portada.`;  } else {
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2023-06-01T00:00:00'); 
  ...
  function update() {
    ...
    container.innerHTML =
      `Comenzamos a escribir nuestras <br>shistoria hace <b>${days}</b> días<br>` +
      `Cumplimos un añito más en: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
